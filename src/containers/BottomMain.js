  ...
  return (
    <div>
     <div className="heading_background">
        <h1 className="BottomMain_heading">“We design and build Kitchens, bathrooms and laundrys.” </h1>
      </div>
        <GridPics/>
        <div className="contact_bottom">
        <h1 className="Secound_bottom_heading">$0 Call-out fee</h1>
        <button  className="contact_button_bottom"><a href="tel:0433310964">Lets chat</a></button>
      </div>
